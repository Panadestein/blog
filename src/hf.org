...
#+begin_src bqn :tangle ./bqn/hf.bqn
  F ← {𝕊e1‿e2‿z1‿z2‿r:
    ...
    erim ← {a𝕊d:
      i ← a{↕𝕩¨↕=𝕨}≠bs
      meri ← {𝕩⊏0‿r}¨i
      (1+↕4){(+˝˘[0‿1‿2, 3‿4‿5]⊸⊏)⎉𝕨 𝕩}´˜ a(d⊸×⊣ERI¨⊢/˜·<¨≢∘⊣÷≢∘⊢)meri
    }´ D 4
  }
  F system
#+end_src
...
#+begin_example
┌─                                         
┆  1.3071516075554825 0.43727932526541674  
   0.4372793252654168  0.6057033663335996  
                                           
   0.4372793252654168 0.17726712195066158  
  0.17726712195066158 0.31179457036897384  
                                           
                                           
   0.4372793252654168 0.17726712195066158  
  0.17726712195066158  0.3117945703689738  
                                           
   0.6057033663335996 0.31179457036897384  
  0.31179457036897384  0.7746083600328786  
                                          ┘
#+end_example
