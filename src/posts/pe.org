#+TITLE: Project Euler medley
#+INCLUDE: "../html-head.org"
#+PROPERTY: header-args :tangle ../bqn/pe.bqn

** Disclaimer

This page contains my BQN solutions to some of the problems in [[https://projecteuler.net/][Project Euler]].
It is discouraged to share them, but I very much dislike writing throw-away code,
and that's why they are here. If you are interested, this is my profile:
...
Let's start by defining some namespaces with utilities that will be shared by several problems:
...
This is gotta be brute force. First I will parse the grid:
...
This computes the answer in 300μs, albeit being brute force.

** Problem 12

#+begin_src bqn
  {𝕊:(𝕩+1)⋈˜1+≠↕⊸(⊣/˜0=|)2÷˜𝕩×𝕩+1}´•_while_(500≥⊑) 0‿100
#+end_src
