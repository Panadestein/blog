...
and that's why they are here. Let's start by defining some namespaces with utilities
that will be shared by several problems:
...
If you are interested, this is my profile:
...
until √500 because \(m\) cannot be larger than it, as \(n\) is positive. Then:
