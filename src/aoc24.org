...
The 1 modifier prints the solution for the two parts, and the 10 runs average the total runtime (including parsing).
For reference, this is the CPU that was used:
